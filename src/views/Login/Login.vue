    ...
    <div class="relative h-full flex mx-auto">
      ...
      >
        ...
        <div class="flex justify-center items-center h-[calc(100%-60px)]">
          ...
          >
            <img src="@/assets/imgs/friends.svg" key="1" alt="" class="w-350px" />
      ...
      <div class="flex-1 p-30px <sm:p-10px dark:bg-v-dark relative">
        ...
        <Transition appear enter-active-class="animate__animated animate__bounceInRight">
          ...
          >
            <LoginForm v-if="formType === 0" v-model:formType="formType" class="p-20px h-auto m-auto <xl:(rounded-3xl light:bg-white)" />
            <RegisterForm v-if="formType === 1" v-model:formType="formType" class="p-20px h-auto m-auto <xl:(rounded-3xl light:bg-white)" />
          </div>
        </Transition>
      </div>
    </div>
